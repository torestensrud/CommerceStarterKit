...
<div id="DataForm">
    ...
    <table class="DataForm">
	    <tr>
		    <td class="FormLabelCell"><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:OrderStrings, Payment_Merchant_ID %>" />:</td>
	    ...
	    <tr>
           ...
           <tr>
		    <td class="FormLabelCell"><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:OrderStrings, Payment_API_User %>" />:</td>
		    <td class="FormFieldCell"><asp:TextBox Runat="server" ID="ApiUser" Width="230"></asp:TextBox><br>			
		    </td>
	    </tr>
	    <tr>
            <td colspan="2" class="FormSpacerCell"></td>
